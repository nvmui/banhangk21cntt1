  ...
  <div style="margin:0 auto; width:700px; border:1px solid #000;">
    ...
    <table width="100%" style="margin-left: 20px">
      ...
      <tr>
        ...
        <td><?php echo "Phương thức thanh toán: "; if($row1['phuongthuc']==1) echo "Qua bưu điện"; else if($row1['phuongthuc']==2) echo "Qua thẻ ATM"; else echo"Thanh toán trực tiếp";?><td>
      </tr>
    </table>
    <table width="95%" style="border-collapse:collapse; margin-left: 20px; margin-right: 20px;">
      ...
      $sql="SELECT * FROM sanpham sp INNER JOIN chitiethd ctdh ON ctdh.IDSanPham = sp.IDSanPham where ctdh.IDHDB='.$madh.'";
